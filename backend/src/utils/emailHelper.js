...
/**
 * Email Helper - Handles all email operations
 */
export const EmailHelper = {
  ...
  async sendEmail(options) {
    try {
      ...
      const mailOptions = {
        from: from || process.env.EMAIL_USER || "noreply@eade-platform.com",
        to: to,
        subject: subject,
        text: text || null,
        html: html || null,
  ...
  async sendWelcomeEmail(options) {
    ...
    const subject = `Welcome to Ethiopian Agricultural Digital Info Exchange`;
    ...
    const text = `Welcome to EADE, ${name || "User"}! You are registered as a ${roleDisplay}. Please visit eade-platform.com to get started.`;
  ...
  /**
   * Send an offer notification email
  ...
  /**
   * Send an offer accepted notification email
  ...
  /**
   * Send a listing created notification email to a buyer
